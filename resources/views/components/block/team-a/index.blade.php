 ...
 <div class="mx-auto max-w-[85rem] bg-gray-200 px-4 py-10 dark:bg-gray-700 sm:px-6 lg:px-8 lg:py-14">
     ...
     <div class="mx-auto mb-10 max-w-2xl text-center lg:mb-14">
         <h2 class="text-2xl font-bold dark:text-white md:text-4xl md:leading-tight">Penguruse</h2>
         <p class="mt-1 text-gray-600 dark:text-gray-400">Pengurus Yayasan Pondok Pesantren Mbod</p>
     </div>
     <!-- End Title -->
     ...
     <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
         <div
             class="flex flex-col rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-slate-900 md:p-6">
         ...
         <a class="group col-span-full flex flex-col justify-center rounded-xl border border-dashed border-gray-200 p-4 text-center hover:shadow-sm dark:border-gray-700 md:p-6 lg:col-span-1"
             href="#">
