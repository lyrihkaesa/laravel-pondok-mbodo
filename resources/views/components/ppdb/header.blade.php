{{-- Header --}}
<header class="flex w-full flex-col text-sm sm:justify-start sm:pb-0">
    <div>
        {{-- Topbar  --}}
        <div
        ...
        {{-- End Topbar --}}
        {{-- Navbar --}}
        <nav class="mx-auto w-full max-w-[85rem] border-b-2 border-gray-100 bg-white px-4 py-2 transition-colors duration-500 dark:border-gray-700 dark:bg-gray-800 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
            aria-label="Global">
