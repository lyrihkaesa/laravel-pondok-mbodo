...
class LawPolicy
{
    ...
    {
        return $user->can('force_delete_law');
    }
    ...
    {
        return $user->can('force_delete_any_law');
    }
    ...
    {
        return $user->can('restore_any_law');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Law $law): bool
    {
