...
test('Registration Success', function () {
    $this->browse(function (Browser $browser) {
        $browser
            ...
            ->scrollIntoView('#data\.informasi-alamat > div > div > div > div:nth-child(4) > div > div > div.grid.auto-cols-fr.gap-y-2 > div > div > div:nth-child(2) > div')
            ...
            ->scrollIntoView('#data\.mother_address')
            ->type('#data\.mother_address', 'Dusun Sendangsari RT005 RW007')
            ->scrollIntoView('#data\.term_01')
            ->pause(2000)
            ->check('#data\.term_01')
            // ->check('#data\.term_02')
            ->check('#data\.term_03')
