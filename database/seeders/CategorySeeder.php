    ...
    public function run(): void
    {
        Category::insert([
            ...
            [
                ...
                'description' => 'Jangan dihapus, ini digunakan untuk filter paket yang akan ditampilkan pada biaya pendaftaran.',
                'is_active' => true,
                'type' => 'paket,produk',
            ],
            [
            ...
            [
                'name' => 'Laki-Laki',
                'slug' => 'laki-Laki',
                'description' => 'Jangan dihapus, ini digunakan untuk filter paket berdasarkan jenis kelamin dari santri.',
                'is_active' => true,
                'type' => 'paket,santri,gender,jenis kelamin',
            ],
            [
                'name' => 'Perempuan',
                'slug' => 'perempuan',
